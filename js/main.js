  ...
  projects: [
    {
      ...
      forks: 1,
      desc: {
        zh: "多智能体深度检索脑卒中临床辅助决策系统 (CDSS)：以本地医学文献与临床指南为知识底座，Hybrid RAG 双路检索（语义 + BM25）配合证据级溯源。全科、神经专科、临床药师三位专家交叉质询形成可审计共识，内置 NIHSS、rt-PA 剂量、ASPECTS 等 18 个卒中领域工具（按评估 → 禁忌症 → 剂量三级优先调度）与结构化绿道预评估，全链路 SSE 实时呈现思考链 —— 证据先行、过程透明、结果合规。",
        en: "A multi-agent, deep-retrieval clinical decision support system (CDSS) for stroke care: built on a local knowledge base of medical literature and clinical guidelines, with dual-path Hybrid RAG (semantic + BM25) and evidence-level citation tracing. General, neurological and pharmacist experts cross-examine each other into an auditable consensus, backed by 18 stroke-specific tools (NIHSS, rt-PA dosing, ASPECTS, …) with level-prioritized calling, structured green-channel triage and full-chain SSE streaming of the reasoning process.",
      },
      tags: {
        zh: ["LangGraph", "Hybrid RAG", "三专家会诊", "18 个卒中工具"],
        en: ["LangGraph", "Hybrid RAG", "Expert Panel", "18 Stroke Tools"],
      },
    },
    {
...
const i18n = {
  zh: {
    ...
    "hero.tagline": "AttentionCoo is all you need.",
